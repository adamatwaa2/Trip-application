...
export default async function PaymentsPage() {
  ...
  return <AdminShell profile={profile} current="/admin/payments">
    <header className="pi-admin-page-head"><p className="pi-admin-kicker">Payments</p><h1>Payments and verification.</h1><p>Paymob payments are verified automatically by a signed callback. Record InstaPay, bank-transfer, cash or terminal payments only after you verify them.</p></header>
